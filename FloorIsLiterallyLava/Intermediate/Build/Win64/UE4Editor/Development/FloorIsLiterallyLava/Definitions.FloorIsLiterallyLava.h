#undef FLOORISLITERALLYLAVA_API
#undef FLOORISLITERALLYLAVA_VTABLE
...
#define UE_PROJECT_NAME FloorIsLiterallyLava
...
#define FLOORISLITERALLYLAVA_VTABLE DLLEXPORT_VTABLE
#define FLOORISLITERALLYLAVA_API DLLEXPORT
